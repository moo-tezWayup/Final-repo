...
public class ClinicService {
    ...
    private final GetServicesByClinicUseCase getServicesByClinicUseCase;
    ...
    public Optional<Clinic> getClinicById(String id) {
        return this.getByIdClinicsUseCase.execute(id);
    }

    public Clinic updateClinic(ClinicDTO clinicDTO, Clinic existingClinic) {
        return this.updateClinicsUseCase.update(clinicDTO, existingClinic);
    }
    ...
    public List<fr.wayUp.cleanArchitecture_demo.domain.model.Service> getServicesByClinicId(String clinicId) {
        return this.getServicesByClinicUseCase.execute(clinicId);
    }
}